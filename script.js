document.getElementById('meuBotao').addEventListener('click', function() {
    ...
    this.style.backgroundColor = '#f3cd24'; // Muda a cor do botão para verde
   });
   ...
   document.getElementById('adicionarLink').addEventListener('click', function() {
    ...
    document.getElementById("adicionarLink").style.color = "white";
    novoLink.addEventListener('click', function(event) {
    event.preventDefault();
    alert('Perdeu, playboy, não tem novo link coisa nenhuma!');
    });
